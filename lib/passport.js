             ...
             new LocalStrategy({
               ...
               passReqToCallback: true
                  ...
                  if (decryptedPassword !== decryptedPasswordConfirmation) {
                    ...
                    delete user.passwordConfirmation; // we don't need this anymore
                  }                 
                  ...
                  if (isError) return done(null, false);  
                         ...
                         .catch(function(err) {
                                  err.errors.forEach(function(err) {
                                    if (err.message === 'Validation len failed') {
                                      ...
                                      req.flash('error', 'your email is address is not a properly formatted');
                                    } else {
